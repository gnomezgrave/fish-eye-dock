...
public class RelativeLayout implements LayoutManager2, java.io.Serializable {
     ...
     * X-AXIS this would refer to the Y alignment. For Y-AXIS this would refer
     * to the X alignment.
     */
    ...
    /**
     * Creates a relative layout with the components layed out on the specified
     * axis using the specfied gap <p> All
     * <code>RelativeLayout</code> constructors defer to this one.
     *
     * @param	axis X-AXIS or Y_AXIS
     * @param	gap the gap
     */
     ...
     * layout. <p> The preferred width of a column layout is the largest
     * preferred width of each column in the container, plus the horizontal
     * padding times the number of columns minus one, plus the left and right
     * insets of the target container. <p> The preferred height of a column
     * layout is the largest preferred height of each row in the container, plus
     * the vertical padding times the number of rows minus one, plus the top and
     ...
     * layout. <p> The minimum width of a grid layout is the largest minimum
     * width of each column in the container, plus the horizontal padding times
     * the number of columns minus one, plus the left and right insets of the
     * target container. <p> The minimum height of a column layout is the
     * largest minimum height of each row in the container, plus the vertical
    ...
    /**
     * Lays out the specified container using this layout. <p> This method
     * reshapes the components in the specified target container in order to
     * satisfy the constraints of the
     * <code>RelativeLayout</code> object. <p> The grid layout manager
     * determines the size of individual components by dividing the free space
     * in the container into equal-sized portions according to the number of
     * rows and columns in the layout. The container's free space equals the
     * container's size minus any insets and any specified horizontal or
